    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    dwtools3.django.helpers.fields.StrippedCharField(blank=True, max_length=255),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_permanent",
                    models.BooleanField(
                        help_text="Whether to use a 301 Permanent redirect for this entry.",
                        default=False,
                    ),
                ),
                (
                    "with_query_string",
                    models.BooleanField(
                        help_text="Whether to preserve any query string present in the source URL when redirecting.",
                        default=False,
                    ),
                ),
            ],
